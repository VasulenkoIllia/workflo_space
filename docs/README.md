...
| [DESIGN_COVERAGE.md](DESIGN_COVERAGE.md)             | 🗺️ **КАНОН РЕАЛЬНОГО СТАНУ КОДУ** — матриця 567 екранів × 29 модулів (дизайн↔бекенд↔маршрут↔codeState↔conformance) + drift. Аудит 2026-06-22, adversarial-verified                                |
| [DESIGN_PHASE2_PLAN.md](DESIGN_PHASE2_PLAN.md)       | 🚧 План Фази 2 (код): виправити 48 conformance-RISK + добудувати 28 backend-ready екранів. Виходить з DESIGN_COVERAGE.md                                                                          |
