...
>
> 🟢 **СТАТУС: ЗАВЕРШЕНО / ІСТОРИЧНИЙ (2026-06-20).** Цей план виконано. Реальний стан реалізації
> по кожному екрану тепер — у [`DESIGN_COVERAGE.md`](DESIGN_COVERAGE.md) (аудит 2026-06-22). Цей файл
> лишено для історії рішень; **за статусом коду звертайся до DESIGN_COVERAGE.md, не сюди**.
