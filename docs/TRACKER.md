...
| P-7  | Погодження оцінки (опційне, requiresApproval) + аванс-гейт (опційний) + договір-гейт блок документів (П3). **+ `hourly_prepaid` cycle-двигун (з P-2):** аванс при старті (гейт 02-В) + звірка факту проти авансу при закритті циклу — потребує аванс-гейту, тож робиться тут                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | 02-А, 02-В    | ⬜                           |
