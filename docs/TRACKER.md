...
2. **Прохід модулів власником ✅ 11.06** → [`MODULE_REVIEW_2026-06.md`](MODULE_REVIEW_2026-06.md). Наступні кроки: **(а) власник затверджує [`PROJECTS_SPEC.md`](PROJECTS_SPEC.md)** (P-0); **(б) [`DESIGN_TZ_2026-06.md`](DESIGN_TZ_2026-06.md) → дизайнеру** (П1 — картка клієнта 360°).
3. **S5.6 «Фінансова модель 2.0»** (новий, див. РЕПЛАН нижче) — ПЕРЕД S6.
...
> **Джерела-канони:** [`MODULE_REVIEW_2026-06.md`](MODULE_REVIEW_2026-06.md) (~95 рішень по 29 модулях) · [`DESIGN_TZ_2026-06.md`](DESIGN_TZ_2026-06.md) (зведене ТЗ дизайнеру) · [`PROJECTS_SPEC.md`](PROJECTS_SPEC.md) (чернетка фін-моделі 2.0).
...
### 🆕 S5.6 — «Фінансова модель 2.0» (НОВИЙ спринт, ПЕРЕД S6)
...
| ---- | --------------------------------------------------------------------------------------------------- | ------------- | ------ |
| P-0  | **Власник затверджує `PROJECTS_SPEC.md`** (відкриті питання → рішення) → фіналізація спеки          | 05-ПРОЕКТИ    | ⬜     |
| P-1  | `Project` + `ProjectExecutorRate` міграція + еволюція `CompanyService` (абонплати → проєкти)        | 05-ПРОЕКТИ    | ⬜     |
| P-2  | Білінг-цикли (N-число / щотижня / вручну) → генерація нарахувань per-проєкт                         | 06-В          | ⬜     |
...
| ID   | Задача                                                                                                                | Коли                       |
| ---- | --------------------------------------------------------------------------------------------------------------------- | -------------------------- |
| AN-1 | **Переосмислення системи ролей** (RBAC: роль «менеджер» 20-А, view-as 20-Б, клієнтські права, SaaS-ролі) — міні-спека | до фронтенд-проходу        |
