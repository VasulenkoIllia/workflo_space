...
Статус модуля в REVIEW: ✅ ПІДТВЕРДЖЕНО (11.06.2026) — «додаємо все, розширяємо функціонал».

| ID   | Рішення                                                               | Вплив                   | Нюанси власника                                                                   |
| ---- | --------------------------------------------------------------------- | ----------------------- | --------------------------------------------------------------------------------- |
| 10-А | **Редаговані тіри per-agency**                                        | [бек+екран налаштувань] | Пороги, %, назви — у налаштуваннях; патерн ReferralSettings                       |
| 10-Б | **Прогрес до наступного тіру** в Portal + нотифікація при ~90% порогу | [бек копійка + віджет]  | —                                                                                 |
| 10-В | **Знижка тіру і на разові/погодинні** — опційно per-agency            | [бек]                   | Перемикач у налаштуваннях; дефолт — як зараз, лише recurring, до окремого рішення |
| 10-Г | **Перки тірів**                                                       | [екран + JSON-поле]     | Текстові бенефіти на сторінці тіру, редаговані                                    |

Для ТЗ дизайнеру: екран налаштувань loyalty-програми в Workspace (А, В, Г); віджет прогресу тіру в Portal /loyalty (Б). _(Попередньо.)_
