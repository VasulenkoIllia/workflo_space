...
- **Далі (TEAM-ADMIN-2):** адмін-екран /team за дизайном workspace-admin.jsx — KPI-стріп,
  таби Підрозділи/Команда·ролі/Запрошення, ієрархія «звітує» (computed: член → лід → owner);
  Permissions-матриця — S14.
