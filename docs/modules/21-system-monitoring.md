...
| ---- | ---------------------------------------------------------------------------------------------------------------- | ----------- | ----------------------------------------- |
| 21-А | **Журнал фонових задач** — `CronRun`: запуски кронів/outbox (статус/підсумок); екран в адмінці + алерт при фейлі | [бек+екран] | Критично через грошові автоцикли (06-В)   |
| 21-Б | **Алерти власнику в Telegram** про здоровʼя системи (деплой, диск, крони, сплеск помилок)                        | [бек/інфра] | Підняти OPS-D1 до діла                    |
| 21-В | **Status-page**                                                                                                  | рішення     | Підтверджено: лишається в S14 (SaaS-фаза) |
