...
- **Картка клієнта 360°** `/clients/:id` — таби Огляд(стати+замовлення+«потребує уваги») · Люди
  ...
  Проєкти · Фінанси(лояльність+override / маржа YTD) · Документи(PDF) · Реквізити(read + agency
  ...
  «Скинути пароль» → користувач отримує лист скидання (сам задає новий, агенція його не бачить)._
