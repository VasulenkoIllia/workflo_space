...
- **Slice №6 — Order-chat фільтр**: «Усі · N / 🔒 внутрішні · M» у ChatTab (client-side, над тредом) + filtered-empty стан.
...
| --- | -------------------------------------------- | ------- | ------------- | -------- | -------------------------------------- |
| 1   | **Юр-онбординг компанії** (форма реквізитів) | 06 Docs | ✅ requisites | П2       | API GET/PATCH готовий; решта 06 = S6+. |
