...
**Офіційно:** джерело правди для візуалу — **готовий дизайн** (`design-v2/`; живий канон — claude.ai «workflo.space»): **лайм-акцент** за замовчуванням, теплі **stone**-нейтралі, **Geist + JetBrains Mono + Caveat**, **термінальна естетика «Engineer's Cut»** (shell завжди у режимі A · Terminal — див. §3.6). Старий бриф (синій/Inter) — **застарілий**.
...
| **documents-eu**             | `workspace-documents-eu.jsx`       | 8      | ✅ **06-Е EU-комплект (6 EN-шаблонів, docKit на юр-особі) + 06-Д публічна сторінка рахунку збудовано** — drift 2026-07-11; лишок: pay-кнопка (05-А) і DocKitViewer-екран | 🟢 MVP (pay-кнопка з 05-А)                         |
| **portal-secrets** (vault)   | `portal-secrets.jsx`               | 3      | ✅ **модуль 17 закрито повністю** (17-А/Б/Д/SHARE/РОТАЦІЯ/2FA-step-up) — drift r5 2026-07-08                                                                             | 🟢 реалізовано                                     |
| **support-plus** (тікети/KB) | `workspace-support-plus.jsx`       | 7      | ◑ **тікет-ядро+тред+SSE збудовано (SUP-MVP)**; canned/KB/CSAT — post-MVP — drift r5 2026-07-08                                                                           | 🟢 MVP (KB post-MVP)                               |
| **calendar-plus**            | `workspace-calendar-plus.jsx`      | 6      | ◑ **зустрічі/RSVP/reminder збудовано (CAL-MVP)**; booking-типи/відпустки — post-MVP — drift r5 2026-07-08                                                                | 🟢 MVP (booking post-MVP)                          |
