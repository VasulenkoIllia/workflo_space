...
/** Password re-entry gate before revealing a vault secret (module 17, 2FA-on-reveal). On success
 * a 5-min grant is cached (lib) and `onSuccess` runs the pending reveal. */
