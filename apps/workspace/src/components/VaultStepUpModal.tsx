...
/** Step-up gate before revealing a vault secret (module 17). TOTP-first (рішення 05.07):
 * with 2FA enabled the proof is a 6-digit authenticator code (or a backup code) — a
 * leaked password alone can't open secrets; without 2FA the password fallback stays.
 * On success a 5-min grant is cached (lib) and `onSuccess` runs the pending reveal. */
